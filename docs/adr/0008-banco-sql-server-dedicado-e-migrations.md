...
- O banco exclusivo foi criado posteriormente sob confirmação explícita e está reconciliado de `V0001` a `V0007` no alvo local dedicado; as validações do runner passaram. Nenhum outro banco foi alterado.
